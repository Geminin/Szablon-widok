...
<body class="home">
				...
				<ul class="nav navbar-nav pull-right">
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu">
							...
							<li><a href="app/Calc/Index_calc.php">Kalkulator</a></li>

							<li><a href="app/Cred/Index_cred.php">Kalkulator Kredytowy</a></li>
	...
	<header id="head">
		<div class="container">
			<div class="row">
				<h1 class="lead">Fajne Projekty Studenta</h1>
				<p class="tagline">Tylko tutaj zobaczysz co tak naprawde potrafi student informatyki</p>
			</div>
		</div>
	</header>
	<!-- /Header -->
	...
	<div class="jumbotron top-space">
		<div class="container">
			...
			<h3 class="text-center thin">Projekty</h3>
